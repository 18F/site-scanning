...
A [scan](https://scanner-ui-exhausted-swan.app.cloud.gov/search200/) to check each domain for the presence or absence of a file at a specific location, specifically by analyzing the server response code at that location.  Candidates include:
